...
typedef void (*Fill_DepthAttachmentDescriptionFnc)(VkAttachmentDescription& desc, depthstencilslot_vk* slot);
typedef void (*Fill_DepthAttachmentReferenceFnc)(VkAttachmentReference& Ref,
												 unsigned int index,
