...
typedef struct tgfx_renderer
{
	...
	struct tgfx_commandBuffer* (*beginCommandBuffer)(struct tgfx_gpuQueue* queue,
	...
	void (*executeBundles)(struct tgfx_commandBuffer* commandBuffer,
						   unsigned int bundleCount,
						   struct tgfx_commandBundle* const* bundles,
						   unsigned int extCount,
						   struct tgfx_extension* const* exts);
	void (*beginRasterpass)(struct tgfx_commandBuffer* commandBuffer,
	...
	void (*endRasterpass)(struct tgfx_commandBuffer* commandBuffer,
						  unsigned int extCount,
						  struct tgfx_extension* const* exts);
	...
	void (*createFences)(struct tgfx_gpu* gpu,
						 unsigned int count,
	...
	void (*queueFenceSignalWait)(struct tgfx_gpuQueue* queue,
	...
	void (*queueExecuteCmdBuffers)(struct tgfx_gpuQueue* queue,
								   unsigned int cmdBufferCount,
								   struct tgfx_commandBuffer* const* cmdBuffers,
								   unsigned int extCount,
								   struct tgfx_extension* const* exts);
	...
	struct tgfx_commandBundle* (*beginCommandBundle)(struct tgfx_gpu* gpu,
