...
//Variable Types!
typedef enum{
  datatype_tgfx_UNDEFINED = 0, datatype_tgfx_VAR_UBYTE8 = 1,
  datatype_tgfx_VAR_BYTE8 = 2, datatype_tgfx_VAR_UINT16 = 3,
  datatype_tgfx_VAR_INT16 = 4, datatype_tgfx_VAR_UINT32 = 5,
  datatype_tgfx_VAR_INT32 = 6, datatype_tgfx_VAR_FLOAT32,
  datatype_tgfx_VAR_VEC2, datatype_tgfx_VAR_VEC3,
  datatype_tgfx_VAR_VEC4, datatype_tgfx_VAR_MAT4x4
} datatype_tgfx;
...
typedef void (*tgfx_windowResizeCallback)(window_tgfxhnd WindowHandle, void* UserPointer, unsigned int WIDTH, unsigned int HEIGHT,
