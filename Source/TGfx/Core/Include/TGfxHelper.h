...
typedef struct tgfx_helper
{
	...
	void (*getGPUInfo_Queues)(struct tgfx_gpu* GPUhnd,
							  unsigned int queueFamIndx,
							  unsigned int* queueCount,
							  struct tgfx_gpuQueue** queueList);
	unsigned char (*getTextureTypeLimits)(enum texture_dimensions_tgfx dims,
	...
	result_tgfx (*getWindow_GPUSupport)(struct tgfx_window* window,
										struct tgfx_gpu* gpu,
