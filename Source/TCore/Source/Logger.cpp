...
struct TCLogServices
{
	...
	static void Destroy() {}
	static void Save(enum TCLogLevel logType, const char* filePath) {}
	static void Log(enum TCLogLevel type, unsigned char stopRunning, const wchar_t* format, ...) {}
};
...
static constexpr wchar_t* statusNames[] = {L"Status", L"Warning", L"Error", L"Not coded", L"Crashing"};
