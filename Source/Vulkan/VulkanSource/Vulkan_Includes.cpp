...
namespace Vulkan {
	...
	VkShaderStageFlags Find_VkShaderStages(GFX_API::SHADERSTAGEs_FLAG flag) {
		...
		if (flag.COMPUTE) {
			found = found | VK_SHADER_STAGE_COMPUTE_BIT;
		}
	...
	VK_API void Find_SubpassAccessPattern(GFX_API::SUBDRAWPASS_ACCESS access, bool isSource, VkPipelineStageFlags& stageflag, VkAccessFlags& accessflag) {
		switch (access)
		{
		case GFX_API::SUBDRAWPASS_ACCESS::ALLCOMMANDS:
			if (isSource) {
			...
			break;
		case GFX_API::SUBDRAWPASS_ACCESS::INDEX_READ:
			stageflag |= VK_PIPELINE_STAGE_VERTEX_INPUT_BIT;
			accessflag |= VK_ACCESS_INDEX_READ_BIT;
			break;
		case GFX_API::SUBDRAWPASS_ACCESS::VERTEXATTRIB_READ:
			stageflag |= VK_PIPELINE_STAGE_VERTEX_INPUT_BIT;
			accessflag |= VK_ACCESS_VERTEX_ATTRIBUTE_READ_BIT;
			break;
		case GFX_API::SUBDRAWPASS_ACCESS::VERTEXUBUFFER_READONLY:
			stageflag |= VK_PIPELINE_STAGE_VERTEX_SHADER_BIT;
			accessflag |= VK_ACCESS_UNIFORM_READ_BIT;
			break;
		case GFX_API::SUBDRAWPASS_ACCESS::VERTEXSBUFFER_READONLY:
		case GFX_API::SUBDRAWPASS_ACCESS::VERTEXSAMPLED_READONLY:
		case GFX_API::SUBDRAWPASS_ACCESS::VERTEXIMAGE_READONLY:
			stageflag |= VK_PIPELINE_STAGE_VERTEX_SHADER_BIT;
			accessflag |= VK_ACCESS_SHADER_READ_BIT;
			break;
		case GFX_API::SUBDRAWPASS_ACCESS::VERTEXSBUFFER_READWRITE:
		case GFX_API::SUBDRAWPASS_ACCESS::VERTEXIMAGE_READWRITE:
			stageflag |= VK_PIPELINE_STAGE_VERTEX_SHADER_BIT;
			accessflag |= VK_ACCESS_SHADER_READ_BIT | VK_ACCESS_SHADER_WRITE_BIT;
			break;
		case GFX_API::SUBDRAWPASS_ACCESS::VERTEXIMAGE_WRITEONLY:
		case GFX_API::SUBDRAWPASS_ACCESS::VERTEXSBUFFER_WRITEONLY:
			stageflag |= VK_PIPELINE_STAGE_VERTEX_SHADER_BIT;
			accessflag |= VK_ACCESS_SHADER_WRITE_BIT;
			break;
		case GFX_API::SUBDRAWPASS_ACCESS::VERTEXINPUTS_READONLY:
			stageflag |= VK_PIPELINE_STAGE_VERTEX_SHADER_BIT;
			accessflag |= VK_ACCESS_SHADER_READ_BIT | VK_ACCESS_UNIFORM_READ_BIT;
			break;
		case GFX_API::SUBDRAWPASS_ACCESS::VERTEXINPUTS_READWRITE:
			stageflag |= VK_PIPELINE_STAGE_VERTEX_SHADER_BIT;
			accessflag |= VK_ACCESS_SHADER_READ_BIT | VK_ACCESS_UNIFORM_READ_BIT | VK_ACCESS_SHADER_WRITE_BIT;
			break;
		case GFX_API::SUBDRAWPASS_ACCESS::VERTEXINPUTS_WRITEONLY:
			stageflag |= VK_PIPELINE_STAGE_VERTEX_SHADER_BIT;
			accessflag |= VK_ACCESS_SHADER_WRITE_BIT;
			break;

		case GFX_API::SUBDRAWPASS_ACCESS::EARLY_Z_READ:
			stageflag |= VK_PIPELINE_STAGE_EARLY_FRAGMENT_TESTS_BIT;
			accessflag |= VK_ACCESS_DEPTH_STENCIL_ATTACHMENT_READ_BIT;
			break;
		case GFX_API::SUBDRAWPASS_ACCESS::EARLY_Z_READWRITE:
			stageflag |= VK_PIPELINE_STAGE_EARLY_FRAGMENT_TESTS_BIT;
			accessflag |= VK_ACCESS_DEPTH_STENCIL_ATTACHMENT_READ_BIT | VK_ACCESS_DEPTH_STENCIL_ATTACHMENT_WRITE_BIT;
			break;
		case GFX_API::SUBDRAWPASS_ACCESS::EARLY_Z_WRITEONLY:
			stageflag |= VK_PIPELINE_STAGE_EARLY_FRAGMENT_TESTS_BIT;
			accessflag |= VK_ACCESS_DEPTH_STENCIL_ATTACHMENT_WRITE_BIT;
			break;
		case GFX_API::SUBDRAWPASS_ACCESS::FRAGMENTUBUFFER_READONLY:
			stageflag |= VK_PIPELINE_STAGE_FRAGMENT_SHADER_BIT;
			accessflag |= VK_ACCESS_UNIFORM_READ_BIT;
			break;
		case GFX_API::SUBDRAWPASS_ACCESS::FRAGMENTSBUFFER_READONLY:
		case GFX_API::SUBDRAWPASS_ACCESS::FRAGMENTSAMPLED_READONLY:
		case GFX_API::SUBDRAWPASS_ACCESS::FRAGMENTIMAGE_READONLY:
			stageflag |= VK_PIPELINE_STAGE_FRAGMENT_SHADER_BIT;
			accessflag |= VK_ACCESS_SHADER_READ_BIT;
			break;
		case GFX_API::SUBDRAWPASS_ACCESS::FRAGMENTSBUFFER_READWRITE:
		case GFX_API::SUBDRAWPASS_ACCESS::FRAGMENTIMAGE_READWRITE:
			stageflag |= VK_PIPELINE_STAGE_FRAGMENT_SHADER_BIT;
			accessflag |= VK_ACCESS_SHADER_READ_BIT | VK_ACCESS_SHADER_WRITE_BIT;
			break;
		case GFX_API::SUBDRAWPASS_ACCESS::FRAGMENTIMAGE_WRITEONLY:
		case GFX_API::SUBDRAWPASS_ACCESS::FRAGMENTSBUFFER_WRITEONLY:
			stageflag |= VK_PIPELINE_STAGE_FRAGMENT_SHADER_BIT;
			accessflag |= VK_ACCESS_SHADER_WRITE_BIT;
			break;
		case GFX_API::SUBDRAWPASS_ACCESS::FRAGMENTINPUTS_READONLY:
			stageflag |= VK_PIPELINE_STAGE_FRAGMENT_SHADER_BIT;
			accessflag |= VK_ACCESS_SHADER_READ_BIT | VK_ACCESS_UNIFORM_READ_BIT;
			break;
		case GFX_API::SUBDRAWPASS_ACCESS::FRAGMENTINPUTS_READWRITE:
			stageflag |= VK_PIPELINE_STAGE_FRAGMENT_SHADER_BIT;
			accessflag |= VK_ACCESS_SHADER_READ_BIT | VK_ACCESS_UNIFORM_READ_BIT | VK_ACCESS_SHADER_WRITE_BIT;
			break;
		case GFX_API::SUBDRAWPASS_ACCESS::FRAGMENTINPUTS_WRITEONLY:
			stageflag |= VK_PIPELINE_STAGE_FRAGMENT_SHADER_BIT;
			accessflag |= VK_ACCESS_SHADER_WRITE_BIT;
			break;
		case GFX_API::SUBDRAWPASS_ACCESS::FRAGMENTRT_READONLY:
			stageflag |= VK_PIPELINE_STAGE_FRAGMENT_SHADER_BIT;
			accessflag |= VK_ACCESS_COLOR_ATTACHMENT_READ_BIT;
			break;
		case GFX_API::SUBDRAWPASS_ACCESS::LATE_Z_READ:
			stageflag |= VK_PIPELINE_STAGE_LATE_FRAGMENT_TESTS_BIT;
			accessflag |= VK_ACCESS_DEPTH_STENCIL_ATTACHMENT_READ_BIT;
			break;
		case GFX_API::SUBDRAWPASS_ACCESS::LATE_Z_READWRITE:
			stageflag |= VK_PIPELINE_STAGE_LATE_FRAGMENT_TESTS_BIT;
			accessflag |= VK_ACCESS_DEPTH_STENCIL_ATTACHMENT_READ_BIT | VK_ACCESS_DEPTH_STENCIL_ATTACHMENT_WRITE_BIT;
			break;
		case GFX_API::SUBDRAWPASS_ACCESS::LATE_Z_WRITEONLY:
			stageflag |= VK_PIPELINE_STAGE_LATE_FRAGMENT_TESTS_BIT;
			accessflag |= VK_ACCESS_DEPTH_STENCIL_ATTACHMENT_WRITE_BIT;
			break;
		case GFX_API::SUBDRAWPASS_ACCESS::FRAGMENTRT_WRITEONLY:
