...
typedef struct tgfx_gpudatamanager {
  ...
  result_tgfx (*createBindingTable)(gpu_tgfxhnd                                     gpu,
                                    const bindingTableDescription_tgfx * desc,
  ...
  result_tgfx (*setBindingTable_Sampler)(bindingTable_tgfxhnd table, unsigned int bindingCount,
                                         const unsigned int*                bindingIndices,
                                         const sampler_tgfxhnd * samplers);
  ...
  result_tgfx (*copyRasterPipeline)(pipeline_tgfxhnd                     basePipeline,
                                    const extension_tgfxhnd * exts,
                                    pipeline_tgfxhnd*                    derivedPipeline);

  result_tgfx (*createComputePipeline)(
    shaderSource_tgfxhnd Source, unsigned int bindingTableCount,
    const bindingTableDescription_tgfx * bindingTableDescs,
    unsigned char isCallBufferSupported, pipeline_tgfxhnd* hnd);
  // Extensions: CallBufferInfo, Specialization Constants
  result_tgfx (*copyComputePipeline)(pipeline_tgfxhnd                     src,
                                     const extension_tgfxhnd * exts,
  ...
  result_tgfx (*createHeap)(gpu_tgfxhnd gpu, unsigned char memoryRegionID,
                            ...
                            const extension_tgfxhnd * exts, heap_tgfxhnd* heap);
  result_tgfx (*getHeapRequirement_Texture)(texture_tgfxhnd texture, unsigned int extCount,
                                            const extension_tgfxhnd * exts,
                                            heapRequirementsInfo_tgfx*           reqs);
  result_tgfx (*getHeapRequirement_Buffer)(buffer_tgfxhnd buffer, unsigned int extCount,
                                           const extension_tgfxhnd * exts,
                                           heapRequirementsInfo_tgfx*           reqs);
  ...
  result_tgfx (*bindToHeap_Buffer)(heap_tgfxhnd heap, unsigned long long offset,
                                   buffer_tgfxhnd buffer, unsigned int extCount,
                                   const extension_tgfxhnd * exts);
  result_tgfx (*bindToHeap_Texture)(heap_tgfxhnd heap, unsigned long long offset,
                                    texture_tgfxhnd texture, unsigned int extCount,
                                    const extension_tgfxhnd * exts);
