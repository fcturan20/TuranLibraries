...
class Camera {
 ...
 public:
  glm::mat4x4 getPerspectiveMat4x4() {
    return glm::perspective(glm::radians(fov_angle), aspect_ratio, near_plane, far_plane);
  }
  glm::mat4x4 getWorld_to_ViewMat4x4() {
    return glm::lookAt(camerapos, camerapos + glm::normalize(camera_dir), glm::vec3(0, 1, 0));
  }
  ...
  void      imguiCameraEditor() {
         vec3_tgfx tgfx_camerapos = {camerapos.x, camerapos.y, camerapos.z},
                   tgfx_cameradir = {camera_dir.x, camera_dir.y, camera_dir.z};
         ...
         camerapos.x  = tgfx_camerapos.x;
         camerapos.y  = tgfx_camerapos.y;
         camerapos.z  = tgfx_camerapos.z;
         camera_dir.x = tgfx_cameradir.x;
         camera_dir.y = tgfx_cameradir.y;
         camera_dir.z = tgfx_cameradir.z;
