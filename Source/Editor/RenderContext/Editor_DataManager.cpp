...
namespace TuranEditor {
	unsigned int Editor_RendererDataManager::WORLDOBJECTs_GLOBALBUFFERID, Editor_RendererDataManager::MATINSTs_GLOBALBUFFERID, Editor_RendererDataManager::CAMERA_GLOBALBUFFERID, Editor_RendererDataManager::LIGHTs_GLOBALBUFFERID,
		Editor_RendererDataManager::SurfaceMatType_ID;
	...
	void* Editor_RendererDataManager::LIGHTsBUFFER_DATA = new bool[364];
	...
	vec3 Editor_RendererDataManager::CameraPos(0, 0, -3), Editor_RendererDataManager::FrontVec(0, 0, 1)
		, Editor_RendererDataManager::FirstObjectPosition(0,0,0);
	...
	void Editor_RendererDataManager::Load_SurfaceMaterialType() {
		...
		*/
		...
		{
			TuranAPI::LOG_STATUS("Loading Vertex Shader!\n");
			string* VERTEXSHADER_SOURCE = TAPIFILESYSTEM::Read_TextFile("C:/dev/Test Renderer/Content/SurfaceUberShader.vert");
			ShaderSource_Resource* VertexShader = new ShaderSource_Resource;
			VertexShader->LANGUAGE = GFX_API::SHADER_LANGUAGEs::GLSL;
			VertexShader->STAGE = GFX_API::SHADERSTAGEs_FLAG::VERTEXSTAGE;
		...
		{
			TuranAPI::LOG_STATUS("Loading Fragment Shader!\n");
			string* FRAGMENTSHADER_SOURCE = TAPIFILESYSTEM::Read_TextFile("C:/dev/Test Renderer/Content/SurfaceUberShader.frag");
			ShaderSource_Resource* FragmentShader = new ShaderSource_Resource;
			FragmentShader->LANGUAGE = GFX_API::SHADER_LANGUAGEs::GLSL;
			FragmentShader->STAGE = GFX_API::SHADERSTAGEs_FLAG::FRAGMENTSTAGE;
	...
	void Editor_RendererDataManager::Load_PointLineMaterialType() {
		...
		{
			TuranAPI::LOG_STATUS("Loading Vertex Shader!\n");
			string* VERTEXSHADER_SOURCE = TAPIFILESYSTEM::Read_TextFile("C:/dev/Test Renderer/Content/PointRendererShader.vert");
			ShaderSource_Resource* VertexShader = new ShaderSource_Resource;
			VertexShader->LANGUAGE = GFX_API::SHADER_LANGUAGEs::GLSL;
			VertexShader->STAGE = GFX_API::SHADERSTAGEs_FLAG::VERTEXSTAGE;
			VertexShader->SOURCE_CODE = *VERTEXSHADER_SOURCE;
		...
		{
			TuranAPI::LOG_STATUS("Loading Fragment Shader!\n");
			string* FRAGMENTSHADER_SOURCE = TAPIFILESYSTEM::Read_TextFile("C:/dev/Test Renderer/Content/PointRendererShader.frag");
			ShaderSource_Resource* FragmentShader = new ShaderSource_Resource;
			FragmentShader->LANGUAGE = GFX_API::SHADER_LANGUAGEs::GLSL;
			FragmentShader->STAGE = GFX_API::SHADERSTAGEs_FLAG::FRAGMENTSTAGE;
			FragmentShader->SOURCE_CODE = *FRAGMENTSHADER_SOURCE;
