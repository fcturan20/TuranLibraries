...
struct tgfx_gpuDataManager
{
	...
	result_tgfx (*createSampler)(struct tgfx_gpu* gpu,
								 const struct tgfx_samplerDescription* desc,
								 struct tgfx_sampler** hnd);
	void (*destroySampler)(struct tgfx_sampler* sampler);

	// Extension can be UNIFORMBUFFER
	result_tgfx (*createBuffer)(struct tgfx_gpu* gpu,
								const struct tgfx_bufferDescription* desc,
	...
	result_tgfx (*createTexture)(struct tgfx_gpu* gpu,
	...
	result_tgfx (*createBindingTable)(struct tgfx_gpu* gpu,
	...
	result_tgfx (*setBindingTable_Texture)(struct tgfx_bindingTable* table,
	...
	result_tgfx (*setBindingTable_Buffer)(struct tgfx_bindingTable* table,
										  unsigned int bindingCount,
										  const unsigned int* bindingIndices,
	...
	result_tgfx (*setBindingTable_Sampler)(struct tgfx_bindingTable* table,
										   unsigned int bindingCount,
										   const unsigned int* bindingIndices,
	...
	result_tgfx (*compileShaderSource)(struct tgfx_gpu* gpu,
	...
	result_tgfx (*createRasterPipeline)(const struct tgfx_rasterPipelineDescription* desc, struct tgfx_pipeline** hnd);
	...
	result_tgfx (*copyComputePipeline)(struct tgfx_pipeline* src,
									   struct tgfx_extension* const* exts,
	...
	result_tgfx (*createHeap)(struct tgfx_gpu* gpu,
							  unsigned char memoryRegionID,
							  unsigned long long heapSize,
							  unsigned int extCount,
							  struct tgfx_extension* const* exts,
							  struct tgfx_heap** heap);
	result_tgfx (*getHeapRequirement_Texture)(struct tgfx_texture* texture,
											  unsigned int extCount,
											  struct tgfx_extension* const* exts,
											  struct tgfx_heapRequirementsInfo* reqs);
	result_tgfx (*getHeapRequirement_Buffer)(struct tgfx_buffer* buffer,
											 unsigned int extCount,
											 struct tgfx_extension* const* exts,
											 struct tgfx_heapRequirementsInfo* reqs);
	// @return FAIL if this feature isn't supported
	result_tgfx (*getRemainingMemory)(struct tgfx_gpu* GPU,
									  unsigned char memoryRegionID,
									  unsigned int extCount,
									  struct tgfx_extension* const* exts,
									  unsigned long long* size);
	result_tgfx (*bindToHeap_Buffer)(struct tgfx_heap* heap,
									 unsigned long long offset,
									 struct tgfx_buffer* buffer,
									 unsigned int extCount,
									 struct tgfx_extension* const* exts);
	result_tgfx (*bindToHeap_Texture)(struct tgfx_heap* heap,
									  unsigned long long offset,
	...
	result_tgfx (*mapHeap)(struct tgfx_heap* heap,
						   unsigned long long offset,
						   unsigned long long size,
						   unsigned int extCount,
						   struct tgfx_extension* const* exts,
