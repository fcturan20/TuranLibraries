...
struct tgfx_core
{
	...
	enum result_tgfx (*load_backend)(struct tgfx_core* parent,
									 enum backends_tgfx backend,
	...
	void (*setInputMode)(struct tgfx_window* windowHnd,
						 enum cursorMode_tgfx cursorMode,
...
#define TGFX_BACKEND_ENTRY()                                                                                           \
	TCORE_FUNC_EXPORT result_tgfx BACKEND_LOAD(const struct tlECS* ecsSys,                                             \
