...
namespace TuranEditor {
	Editor_System::Editor_System(TuranAPI::Threading::JobSystem* JobSystem) : LOGGING("C:/dev/VulkanRenderer"), JobSys(JobSystem){
		...
		//Search for RGBA8UB supported memory type that's device local
		{
			...
			RGBA8UB_IM.DIMENSION = GFX_API::TEXTURE_DIMENSIONs::TEXTURE_2D;
			RGBA8UB_IM.CHANNEL_TYPE = GFX_API::TEXTURE_CHANNELs::API_TEXTURE_RGBA8UB;
			...
			LOG_STATUS_TAPI("Before GetTextureTypeLimits()");
			...
			LOG_STATUS_TAPI("After GetTextureTypeLimits()");
