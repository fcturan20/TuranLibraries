...
TCORE_PLUGIN_DEFINE(TWindowing, "TWindowing", TCORE_MAKE_PLUGIN_VERSION(0, 0, 0));
...
typedef struct ITWindowing
{
    ...
    // description.
    void (*CreateWindow)(const TCWindowDescription* desc,
                         void* user,
                         struct twindow** outWindowHandle);
} ITWindowing;
