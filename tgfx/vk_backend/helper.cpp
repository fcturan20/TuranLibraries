...
struct helper_functions {
    ...
    static void  GetGPUInfo_General(gpu_tgfx_handle GPUHandle, const char** NAME, unsigned int* API_VERSION, unsigned int* DRIVER_VERSION, gpu_type_tgfx* GPUTYPE, memorytype_tgfx_listhandle* MemTypes,
    ...
    static void  GetGPUInfo_Memory(memorytype_tgfx_handle MemoryType, memoryallocationtype_tgfx* AllocType, unsigned long long* MaxAllocSize) {
    ...
    static result_tgfx SetMemoryTypeInfo(memorytype_tgfx_handle MemoryType, unsigned long long AllocationSize, extension_tgfx_listhandle Extensions) {
...
static void set_helper_functions() {
    ...
    core_tgfx_main->helpers->GetGPUInfo_Memory = &helper_functions::GetGPUInfo_Memory;
