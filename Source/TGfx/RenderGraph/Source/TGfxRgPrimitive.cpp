...
void ConvertSubpassWaits(passwaitdescription_tgfx_listhandle passwaits,
						 VKHANDLETYPEs passwaittype,
...
uint32_t convert_waitdesc_toSubPassWait(VKDATAHANDLE deschandle)
{
	...
	WaitDescStruct::TARGETPASS_STRUCT* targetpass =
		(WaitDescStruct::TARGETPASS_STRUCT*)VK_MEMOFFSET_TO_POINTER(target_mainpasshandle.OBJ_memoffset);
...
#endif
	uint32_t passwaitPTR =
		vk_virmem::allocate_from_dynamicmem(framegraphsys_vk::WAITs_DYNAMICMEM, sizeof(RenderGraph::WaitDescFinal));
